...
function Banner() {
  return (
    <div className='min-h-[550px] flex justify-center items-center py-2 sm:py-0' id='review'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                ...
                <div className="flex flex-col justify-center gap-6 sm:pt-0">
                    ...
                    <p  data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error rerum, incidunt asperiores ipsa vero adipisci, quia excepturi ad dolorum magni dicta veritatis magnam mollitia ducimus officiis ratione nostrum nihil atque.
                    </p>
